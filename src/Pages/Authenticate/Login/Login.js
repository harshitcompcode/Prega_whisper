            ...
            <Row xs={1} md={2} className='align-items-center'>
                <Col className='col-md-5'>
                    <div>
                        <Image
                            className="w-100 p-5"
                            src="https://e7.pngegg.com/pngimages/882/777/png-clipart-basti-district-accredited-social-health-activist-national-health-mission-sri-ganganagar-the-pregnant-woman-can-enjoy-the-gourmet-people-friendship.png"
                            alt=""
                        />
                    </div>
                </Col>
                <Col style={{ textAlign: 'left' }} className='p-5 col-md-7'>
                    <Form>
                        <h2 className='text-primary'>Register for  MidWife</h2><hr />
                        <Form.Group className="mb-3" controlId="formBasicEmail">
                            <Form.Label>Organisation or Individual Mail</Form.Label>
